import { JsonApiINodeProvider, JsonApi } from "@counterfactual/types";
import EventEmitter from "eventemitter3";

export default class JsonApiNodeProvider implements JsonApiINodeProvider {
  /**
  ...
  public async connect(): Promise<JsonApiNodeProvider> {
    if (this.isConnected) {
    ...
    return new Promise<JsonApiNodeProvider>((resolve, reject) => {
