import AppInstanceAdjudicator from "@counterfactual/contracts/build/AppInstanceAdjudicator.json";
...
describe("Uninstall Commitment", () => {
  ...
  describe("the calldata of the multisend transaction", () => {
    ...
    describe("the transaction to update the free balance", () => {
      ...
      it("should be to the AppInstanceAdjudicator", () => {
        expect(to).toBe(networkContext.AppInstanceAdjudicator);
      });
      ...
      describe("the calldata", () => {
        ...
        beforeAll(() => {
          iface = new Interface(AppInstanceAdjudicator.abi);
