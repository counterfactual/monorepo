...
cp $COUNTERFACTUAL_PATH/packages/cf.js/dist/index-iife.js /greenboard-workspace/metamask/app/vendor/counterfactual/node/cf.js.iife.js
cp $COUNTERFACTUAL_PATH/packages/node/dist/index.iife.js /greenboard-workspace/metamask/app/vendor/counterfactual/node/node.iife.js
cp $COUNTERFACTUAL_PATH/packages/firebase-client/dist/index.iife.js /greenboard-workspace/metamask/app/vendor/counterfactual/node/firebase-client.iife.js

cd /greenboard-workspace/metamask
...
unlink $COUNTERFACTUAL_PATH/packages/greenboard/extension || true
mv /greenboard-worspace/metamask/dist/chrome $COUNTERFACTUAL_PATH/packages/greenboard/extension
