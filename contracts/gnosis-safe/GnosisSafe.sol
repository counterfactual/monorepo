...
contract GnosisSafe {
	...
	function confirmTransaction(address to, uint256 value, bytes data, Operation operation)
		public
	{
	...
	function getTransactionHash(address to, uint256 value, bytes data, Operation operation)
		public
		view
		returns (bytes32)
	{
		return keccak256(byte(0x19), this, to, value, data, operation);
	}
